  ...
  return (
    ...
    >
      <div className="text-center max-w-2xl animate-fadeIn">
        <h1 className="text-4xl md:text-5xl font-medium mb-4"> {/* Adjusted sizes for responsiveness */}
          We guarantee improved learning for a better society
        </h1>
        <p className="max-w-xl mx-auto my-4 text-base md:text-lg"> {/* Adjusted sizes for responsiveness */}
